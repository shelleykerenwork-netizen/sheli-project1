              ...
              {q.distribution && q.distribution.length > 0 && (
                q.distribution.length <= 5 ? (
                  <ResponsiveContainer width="100%" height={200}>
                    <PieChart>
                      <Pie data={q.distribution.map(d => ({ name: d.label, value: d.count }))} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={75} label={({ name, value }) => `${name}: ${value}`}>
                  ...
                  <ResponsiveContainer width="100%" height={200}>
                    <BarChart data={q.distribution.map(d => ({ name: d.label, count: d.count }))}>
